...
class PZuweisungGfx implements VTImage.PainterAndListener {
	...
	public PZuweisungGfx(Applet applet) {
		this.applet = applet;
		reset();
	}
	...
	private PZuweisungGfx copySrc = null;
	
	public void copyReversedFrom(PZuweisungGfx src, boolean withConn) {
		copySrc = src;
