...
public class Applet extends JApplet {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			String[] choices = new String[] {"i", "1", "π", "k", "e^x", "e^y"};
