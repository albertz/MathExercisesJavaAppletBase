...
public class Applet extends JApplet {
	...
	private int resZaehler = 0;
	private int resNenner = 0;
	...
	private void updateDefaultVisualThings() {
		...
		resZaehler = getBruchZaehler(a * c, b * d);
		resNenner = getBruchNenner(a * c, b * d);
	...
	public boolean isCorrect(int selId, String selected) {
		switch(selId) {
		case 1: return GGT(parseNum(selected), resZaehler) == resZaehler;
		case 2: return parseNum(selected) == resNenner * (parseNum(getSelected(1)) / resZaehler);
		}
		return false;
	}
